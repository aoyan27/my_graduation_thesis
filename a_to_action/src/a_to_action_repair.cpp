...
int main(int argc, char *argv[]){
	...
	while(ros::ok()){
		if(pub_flag){
			action_type_joint1.data = action_num/(int)pow(3.0, 4.0);
			action_type_joint2.data = (action_num%(int)pow(3.0, 4.0))/(int)pow(3.0, 3.0);
			action_type_joint3.data = (action_num%(int)pow(3.0, 3.0))/(int)pow(3.0, 2.0);
			action_type_joint4.data = (action_num%(int)pow(3.0, 2.0))/(int)pow(3.0, 1.0);
			action_type_joint5.data = (action_num%(int)pow(3.0, 1.0))/(int)pow(3.0, 0.0);
			...
			cout<<"action type joint4 : "<<action_type_joint4.data<<endl;
