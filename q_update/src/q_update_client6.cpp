...
int init_state2 = 21600;

int init_next = 17700;
int init_next_temp = 17700;
...
int main(int argc, char *argv[]){
	...
	const char *fqiname = "/home/amsl/ros_catkin_ws/src/arm_q_learning/q_table/q_table_cari12_random_init/q_table_2500.txt";
	char fqname[100];
	...
	while(ros::ok()){
				/*	while(1){
						...
						rand_joint5 = rand()%10;
						printf("rand_joint1 : %d\n",rand_joint1);
						printf("rand_joint3 : %d\n",rand_joint3);
						printf("rand_joint5 : %d\n",rand_joint5);
		...
		if(wait_flag){
			...
			if(reward >= 1){
				...
				// init_next_temp = ((rand()%21-10) - init_state_joint1) * 700 + ((rand()%21+40) - init_state_joint3) * 10;
				// printf("init_next_temp : %d\n", init_next_temp);
				// if(init_next_temp%700 ==0 &&  (init_next_temp>=21000 && init_next_temp<=28000)){
					// if(episode_count%2 == 0){	
						// init_next = init_state;
					// }
					// else{
						// init_next = init_state2;
					// }
				// }
				// else{
					// init_next = init_next_temp;
				...
				/*	while(1){
					...
					// init_next_temp = ((rand()%21-10) - init_state_joint1) * 700 + ((rand()%21+40) - init_state_joint3) * 10;
					// printf("init_next_temp : %d", init_next_temp);
					// if(init_next_temp%700 ==0 &&  (init_next_temp>=21000 && init_next_temp<=28000)){
						// if(episode_count%2 == 0){
							// init_next = init_state;
						// }
