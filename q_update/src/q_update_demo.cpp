...
int main(int argc, char *argv[]){
	ros::init(argc, argv, "q_update_demo");
	ros::NodeHandle n;
	
	FILE *fp;
	FILE *fpq;
	// const char *fname = "/home/amsl/ros_catkin_ws/src/arm_q_learning/test_results/ql_test_demo.txt";
	const char *fqname = "/home/amsl/ros_catkin_ws/src/arm_q_learning/q_table/q_table/q_table_1000.txt";
	// char fqname[100];
