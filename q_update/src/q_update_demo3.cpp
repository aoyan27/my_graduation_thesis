...
int main(int argc, char *argv[]){
	ros::init(argc, argv, "q_update_demo3");
	ros::NodeHandle n;
	...
	const char *fqname = "/home/amsl/ros_catkin_ws/src/arm_q_learning/q_table/q_table_cari15/q_table_1800.txt";
	// char fqname[100];
	// char fqsname[100];
