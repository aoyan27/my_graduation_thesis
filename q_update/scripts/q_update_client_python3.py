...
class agent:
	...
	def __init__(self):
		...
		self.state = 0
		self.next_state = 0
                #  self.Qtable = np.loadtxt("/home/amsl/ros_catkin_ws/src/arm_q_learning/q_table/q_table_python/q_table_1000.txt", delimiter=",")
                #  print "now loading Qtable!!"
	...
	def epsilon_greedy(self, s):
        ...
        def main(self):
            rospy.init_node('q_update_client_python_random')
            ...
            while not rospy.is_shutdown():
                if self.wait_flag:
                    ...
                    if episode_count > 100:
                        print test_result
                        np.savetxt("test_result.txt", test_result, fmt="%d", delimiter=",")
                        print "Finish!!!"
                        break
