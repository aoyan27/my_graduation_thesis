...
class agent:
	...
	state_observation_flag3 = False
		...
		self.num_step = 0
                ...
                f = open('/home/amsl/ros_catkin_ws/src/arm_q_learning/dqn_model/dqn_test29_dedede/dqn_arm_model_35000.dat', 'rb')
	...
	def epsilon_greedy(self, joint1, joint2, joint3):
        ...
        def main(self):
            ...
            pub_12 = rospy.Publisher("/joint2_pose_com", Float64, queue_size = 1)
                ...
                if self.start_flag:    
                    if self.wait_flag:
                        ...
                        if self.button_wait_flag:
                            ...
                            #  self.target_point.points[0].x = math.sqrt(self.L_2**2 - self.target_point.points[0].y**2) + 0.270
                            #  self.target_point.points[0].z = 0.90
                            ...
                            if self.mode_dqn_flag:
                                ...
                                if (joint5_com_limit <= 1 and joint3_com_limit <= 1) and x_addition < 0.10:
                                ...
                                pub_11.publish(joint1_com)
                                print "joint1 command publish!!"
                                pub_12.publish(joint2_com)
                                print "joint2 command publish!!"
                                rospy.sleep(0.05)
                                pub_13.publish(joint3_com)
                                print "joint3 command publish!!"
                                pub_15.publish(joint5_com)
