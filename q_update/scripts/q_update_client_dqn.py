...
class agent:
	...
	def __init__(self):
		...
		self.next_state = 0
                ...
                self.model = chainer.FunctionSet(
                        l1 = F.Linear(3, 1024),
                        l2 = F.Linear(1024, 640),
                        l3 = F.Linear(640, 320),
                        l4 = F.Linear(320, 27, initialW=np.zeros((27, 320), dtype=np.float32)),
                        )
                if args.gpu >= 0:
                    self.model.to_gpu()
	...
	def joint_states_callback(self, msg):
        ...
        def forward(self, joint1_data, joint3_data, joint5_data):
            ...
            joint3_data_float = float(joint3_data) / 70.0
