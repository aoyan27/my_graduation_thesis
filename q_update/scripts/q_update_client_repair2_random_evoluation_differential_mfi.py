...
class agent:
	...
	def epsilon_greedy(self, joint1, joint3, joint5):
        ...
        def main(self):
            ...
            differential_list = np.array([])
            step_count_list = np.array([])
                    ...
                    if self.mode_dqn_flag:
                        ...
                        if self.reward_flag:
                            ...
                            if self.reward >= 1:
                                ...
                                next_arm_pose_x, next_arm_pose_y, next_arm_pose_z = self.forward_kinematics(self.next_joint1, self.next_joint2, self.next_joint3, self.next_joint5)
                                print "self.joint1, self.joint2, self.joint3, self.joint5 : ", self.joint1, self.joint2, self.joint3, self.joint5
                                print "self.next_joint1, self.next_joint2, self.next_joint3, self.next_joint5 : ", self.next_joint1, self.next_joint2, self.next_joint3, self.next_joint5
                                print "arm_pose_x, arm_pose_y, arm_pose_z : ", arm_pose_x+0.270, -1*arm_pose_y+0.000, arm_pose_z+0.935
                                print "next_arm_pose_x, next_arm_pose_y, next_arm_pose_z : ", next_arm_pose_x+0.270, -1*next_arm_pose_y+0.000, next_arm_pose_z+0.935

                                differential = (next_arm_pose_x - arm_pose_x) + (next_arm_pose_y - arm_pose_y) + (next_arm_pose_z - arm_pose_z)

                                differential_list = np.append(differential_list, np.array([differential]))
                                print "differential_list : ", differential_list
                                step_count_list = np.append(step_count_list, np.array([step_count]))
                                print "step_xount_list : ", step_count_list
            ...
            ax2.plot(step_count_list, differential_list)

            fig2.savefig("sample_path_result2.png", format="png", dpi=200)
            #  fig2.show()
            ...
            fig.savefig("sample_path_result.png", format="png", dpi=200)
            #  fig.show()
