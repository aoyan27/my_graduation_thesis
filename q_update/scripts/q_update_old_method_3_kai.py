...
class agent:
    ...
    def J11(self, arm_end_x, arm_end_y, arm_end_z,  joint2_rad, joint3_rad):
        joint5_rad = 45.0 /180.0 * math.pi
        ...
        differential = (self.function1(arm_end_x, arm_end_y, arm_end_z, joint2_rad-2*h, joint3_rad)-8*(self.function1(arm_end_x, arm_end_y, arm_end_z, joint2_rad-h, joint3_rad))+8*(self.function1(arm_end_x, arm_end_y, arm_end_z, joint2_rad+h, joint3_rad))-(self.function1(arm_end_x, arm_end_y, arm_end_z, joint2_rad+2*h, joint3_rad)))/12*h

        return differential

    def J12(self, arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad):
        joint5_rad = 45.0 /180.0 * math.pi
        differential0 = -1 * (-1 * (self.L4 + self.L5) * math.sin(joint2_rad + joint3_rad) - self.L6 * math.sin(joint2_rad + joint3_rad - joint5_rad))
        differential = (self.function1(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad-2*h)-8*(self.function1(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad-h))+8*(self.function1(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad+h))-(self.function1(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad+2*h)))/12*h 
    ...
    def J21(self, arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad):
        joint5_rad = 45.0 /180.0 * math.pi
        ...
        differential = (self.function2(arm_end_x, arm_end_y, arm_end_z, joint2_rad-2*h, joint3_rad)-8*(self.function2(arm_end_x, arm_end_y, arm_end_z, joint2_rad-h, joint3_rad))+8*(self.function2(arm_end_x, arm_end_y, arm_end_z, joint2_rad+h, joint3_rad))-(self.function2(arm_end_x, arm_end_y, arm_end_z, joint2_rad+2*h, joint3_rad)))/12*h
        

        return differential

    def J22(self, arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad):
        joint5_rad = 45.0 /180.0 * math.pi
        #  differential = -1 * ((self.L4 + self.L5) * math.cos(joint2_rad + joint3_rad) + self.L6 * math.cos(joint2_rad + joint3_rad - joint5_rad))
        differential = (self.function2(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad-2*h)-8*(self.function2(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad-h))+8*(self.function2(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad+h))-(self.function2(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad+2*h)))/12*h 

        return differential
    
    def inverse_matrix(self, arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad):

        j11=self.J11(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad)
        j12=self.J12(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad)
        j21=self.J21(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad)
        j22=self.J22(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad) 
    ...
    def ucal(self, arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad):
        ...
        det = self.J11(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad) * self.J22(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad) - self.J12(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad) * self.J21(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad)

        u_joint2 = -1 / det * (self.J22(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad) * self.function1(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad) - self.J12(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad) * self.function2(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad))

        u_joint3 = 1 / det * (self.J21(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad) * self.function1(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad) - self.J11(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad) * self.function2(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad))
        
        
        
        inv_j11=1/det*self.J22(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad)
        inv_j12=-1/det*self.J12(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad)
        inv_j21=-1/det*self.J21(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad)
        inv_j22=1/det*self.J11(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad) 
        ...
        #  print inv_jacobian
        print "ucal"
        print  u_joint2, u_joint3
        return u_joint2, u_joint3

    def ucal2(self, arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad):
        inverse=self.inverse_matrix(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad)
        #  print inverse
        u_joint2=-(inverse[0][0]*self.function1(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad)+inverse[0][1]*self.function2(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad))
        u_joint3=-1*inverse[1][0]*self.function1(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad)-inverse[1][1]*self.function2(arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad)
    ...
    def newton2(self, arm_end_x, arm_end_y, arm_end_z, joint2_rad, joint3_rad):
        ...
        for i in range(max_repeat):
            ...
            u_joint2a, u_joint3b = self.ucal(arm_end_x, arm_end_y, arm_end_z, joint2, joint3)
           
            u_joint2, u_joint3 = self.ucal2(arm_end_x, arm_end_y, arm_end_z, joint2, joint3)
            joint2 += u_joint2
            joint3 += u_joint3
                ...
                if self.state_observation_flag and self.state_observation_flag1 and self.state_observation_flag2 and self.state_observation_flag3:
                    if self.approach_flag:
                        if i < len(self.next_arm_end_point.points):
                            ...
                            print "j1(float 1 deg) : ", float(int(j1))
                            print "j2(float 1 deg) : ", float(int(j2)) 
                            print "j3(float 1 deg) : ", float(int(j3))
                            print "j5(float 1 deg) : ", float(int(j5))
                            ...
                            pub_1.publish(float(int(j1)))
                            pub_2.publish(float(int(j2)))
                            pub_3.publish(float(int(j3)))
                            pub_5.publish(float(int(j5)))
