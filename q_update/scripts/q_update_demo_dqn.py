...
class agent:
	...
	def __init__(self):
		...
		self.next_state = 0
                ...
                #  self.model = chainer.FunctionSet(
                        ...
                        #  )
                f = open('/home/amsl/ros_catkin_ws/src/arm_q_learning/dqn_model/dqn_arm_model.dat', 'rb')
	...
	def joint_states_callback(self, msg):
        ...
        def forward(self, joint1_data, joint3_data, joint5_data):
            ...
            x = chainer.Variable(xp.array([[joint1_data_float, joint3_data_float, joint5_data_float, action_data_float]], dtype=xp.float32))
            print "x :  ", x.data
