...
double arm_pose_init[3]={0.776, 0.080, 1.005};

double target_pose[3]={0.780, 0.000, 1.004};
...
double	distance_past = celi2(sqrt(pow(target_pose[0]-arm_pose_init[0], 2) 
			+ pow(target_pose[1]-arm_pose_init[1], 2) + pow(target_pose[2]-arm_pose_init[2], 2)), 4);

double	distance_now =celi2(sqrt(pow(target_pose[0]-arm_pose_init[0], 2) 
			+ pow(target_pose[1]-arm_pose_init[1], 2) + pow(target_pose[2]-arm_pose_init[2], 2)), 4);
...
bool reward_server_callback(reward_calculation::reward::Request &req,
	...
	distance_now = celi2(sqrt(pow(target_pose[0]-arm_pose[0], 2)
			+ pow(target_pose[1]-arm_pose[1], 2) + pow(target_pose[2]-arm_pose[2], 2)), 4);
